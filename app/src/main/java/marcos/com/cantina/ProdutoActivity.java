...
public class ProdutoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        value[1]=5.00;
        p1.setText("Combo salgado COM refri"+" - R$ "+String.format("%.2f", value[1]).replace('.', ','));
        ...
        value[3]=1.50;
        p3.setText("Suco Del Valle"+" - R$ "+String.format("%.2f", value[3]).replace('.', ','));
        ...
        value[4]=2.00;
        p4.setText("Torta"+" - R$ "+String.format("%.2f", value[4]).replace('.', ','));
        ...
        value[5]=1.00;
        p5.setText("Pepsi"+" - R$ "+String.format("%.2f", value[5]).replace('.', ','));
        ...
        value[6]=0.75;
        p6.setText("Doritos"+" - R$ "+String.format("%.2f", value[6]).replace('.', ','));
        ...
        value[7]=2.50;
        p7.setText("Coca-Cola"+" - R$ "+String.format("%.2f", value[7]).replace('.', ','));
        ...
        value[8]=1.00;
        p8.setText("Beijinho"+" - R$ "+String.format("%.2f", value[8]).replace('.', ','));
        ...
        value[9]=1.00;
        p9.setText("Dogão"+" - R$ "+String.format("%.2f", value[9]).replace('.', ','));
